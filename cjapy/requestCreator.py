...
class RequestCreator:
    ...
    def addMetric(
        ...
        **kwargs
        ...
        if attributionModel not in ["lastTouch", "firstTouch", "linear", "participation", "sameTouch", "uShaped", "jShaped", "reverseJShaped", "timeDecay", "positionBased", "algorithmic"]:
            raise ValueError("Invalid attribution model")
              
        if lookbackGranularity not in ["minute", "hour", "day", "week", "month", "quarter"]:
